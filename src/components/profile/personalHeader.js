        ...
        <div className="flex flex-col items-center bg-white p-4 border border-gray-primary rounded">
          ...
          <div className="container flex justify-center items-center">
            <p>
              ...
              design takes its cues from listening to the basic needs of the user and implementing
              strategies to help them traverse obscurities. I lead with a keen eye for teamwork, an
              appetite for learning, and a passion for perspective. Teams I’ve led in the past,
              through operations and business management, have performed at a high level in
              exceeding user expectations, and have sustained that peak of performance by leveraging
              trust in teammates and executing one vision while not compromising personal values.
              I’m looking to create more ways to seamlessly implement technology into the most
              common of everyday tasks.
            </p>
          </div>
        </div>
      </div>
